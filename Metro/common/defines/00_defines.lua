...
NDiplomacy = {
	...
	MIN_WARGOAL_JUSTIFY_COST = 1.2,					-- It always takes atleast 10 days to justify a wargoal
...
NCountry = {
	...
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.25,	-- Default stability rulling party popularity factor
...
NMilitary = {
	...
	BASE_DIVISION_SUPPORT_SLOT_COST = 20, 	--Base cost to unlock a support slot
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 0.01,
