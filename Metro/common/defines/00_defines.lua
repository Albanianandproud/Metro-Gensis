...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 2,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 5,						-- Days of client lag for pause of gamespeed.
...
NDiplomacy = {
	...
	TRUCE_PERIOD_AFTER_KICKING_FROM_FACTION = 14,				-- Truce period after kicking someone from faction in days.
	NUM_DAYS_TO_ENABLE_KICKING_NEW_MEMBERS_OF_FACTION = 14,			-- Number of days before being able to kick a new member of faction 
	NUM_DAYS_TO_ENABLE_REINVITE_KICKED_NATIONS = 28,			-- Number of days before being able to re invite a kicked nation to your faction
	BASE_NEGATIVE_OPINION_AFTER_BEING_KICKED = 25,				-- Negative opinion that will be received after kicking a nation
	DECAY_RATE_OF_NEGATIVE_OPINION_AFTER_BEING_KICKED = 1,			-- Weekly decay rate of the negative opinion
	TRUCE_BREAK_COST_PP = 150,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	...
	BASE_GENERATE_WARGOAL_DAILY_PP = 0.5,	-- Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -0.75, 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -0.7,			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
	...
	MIN_WARGOAL_JUSTIFY_COST = 1,					-- It always takes atleast 10 days to justify a wargoal
	...
	GUARANTEE_COST = 250,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 250,
	...
	BASE_CONDITIONAL_PEACE_WARESCORE_RATIO = 0.1, 	-- Warscore ratio needed for the losing side to able to surrender.
	BASE_CONDITIONAL_PEACE_MONTHS = 2,				-- War length must be before a surrender i possible.
	...
	PEACE_MIN_SCORE = 0.4,							-- Value how much of your score you are always allowed to take
...
NCountry = {
	...
	MAJOR_MIN_FACTORIES = 40,						-- need at least these many factories to become a major
	...
	MIN_MAJOR_COUNTRIES	= 6,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 16,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	DIVISION_SIZE_FOR_XP = 5,                   -- how many battalions should a division have to count as a full divisions when calculating XP stuff
	...
	BASE_FORT_PENALTY = -0.02, 				       -- fort penalty
	...
	ENCIRCLED_PENALTY = -0.4,                      -- penalty when completely encircled
	...
	TRAINING_EXPERIENCE_SCALE = 50.0,
	TRAINING_ORG = 0.2,
	...
	FIELD_EXPERIENCE_MAX_PER_DAY = 0.2,				-- Most xp you can gain per day
	EXPEDITIONARY_FIELD_EXPERIENCE_SCALE = 0.5,		-- reduction factor in Xp from expeditionary forces
	LEND_LEASE_FIELD_EXPERIENCE_SCALE = 0.05,		-- Experience scale for lend leased equipment used in combat.
	...
	SUPPLY_GRACE = 48,							   -- troops always carry 3 days of food and supply
